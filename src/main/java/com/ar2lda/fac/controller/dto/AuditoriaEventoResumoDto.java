...
public record AuditoriaEventoResumoDto(Long id, OffsetDateTime dataHora, TipoAuditoriaEvento tipoEvento,
        String entidadeTipo, String entidadeId, String utilizadorId, String utilizadorNome, String utilizadorPerfil,
        ResultadoAuditoria resultado, String referencia, String descricao) {
}
