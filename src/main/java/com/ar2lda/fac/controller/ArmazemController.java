...
import com.ar2lda.fac.service.ArmazemService;
...
public class ArmazemController implements GenericController {

    private final ArmazemService service;

    @PostMapping
    public ResponseEntity<ArmazemDto> create(@RequestBody @Valid ArmazemCreateDto dto) {
        ArmazemDto created = service.create(dto);
