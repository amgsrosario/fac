...
const configs: Record<TableKey, Config> = {
  "tipos-documento": {
    ...
    fields: [field("id", "Codigo", { required: true, maxLength: 3, createOnly: true }), field("descricao", "Descricao", { required: true, maxLength: 50 }), field("modeloEmissao1", "Modelo de emissao 1", { maxLength: 25 }), field("modeloEmissao2", "Modelo de emissao 2", { maxLength: 25 }), field("modeloEmissao3", "Modelo de emissao 3", { maxLength: 25 }), field("modeloEmissao4", "Modelo de emissao 4", { maxLength: 25 }), field("areaGestao", "Area de gestao", { type: "number", required: true }), field("entidade", "Entidade", { type: "number", required: true }), field("sinalContabilistico", "Sinal contabilistico", { type: "select", required: true, options: "sinais" }), field("liquidacaoImediata", "Liquidacao imediata", { type: "checkbox" })],
    columns: [{ key: "id", label: "Codigo" }, { key: "descricao", label: "Descricao" }, { key: "areaGestao", label: "Area" }, { key: "liquidacaoImediata", label: "Liquidacao imediata" }],
